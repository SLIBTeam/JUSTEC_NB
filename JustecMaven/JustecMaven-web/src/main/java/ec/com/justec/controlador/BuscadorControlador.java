...
public class BuscadorControlador extends BaseControlador implements Serializable {
    ...
    public void buscar() {
        try {
            mostrarDocumentos = Boolean.FALSE;
            mostrarSecciones = Boolean.FALSE;
//            documentosEncontrados = new ArrayList<Documento>();
            ...
            System.out.println("Documentos encontrados: " + documentosEncontradosTotal.size());
    ...
    public void obtenerSecciones(Pais pais) {
        System.out.println("obtener Secciones");
        ...
        for (Seccion s : resultadoSeccionesMap.keySet()) {
            System.out.println("seccion: " + s.getNombreSec() + " valor: " + resultadoSeccionesMap.get(s));
        }
